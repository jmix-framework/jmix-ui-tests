...
class BrowserFrameRelativeUiTest extends BaseSamplerUiTest {

    @ParameterizedTest(name = "Checks BrowserFrame with RelativePathResource")
    @ValueSource(strings = ["programmaticBrowserFrame", "declarativeBrowserFrame"])
    void checkBrowserFrameRelativePathResource(String browserFrameJTestId) {
        openSample('browserframe-relative')
